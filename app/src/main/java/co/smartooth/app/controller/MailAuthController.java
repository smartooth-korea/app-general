...
public class MailAuthController {
	...
	@ResponseBody
		...
		logger.debug("========== MailAuthController ========== emailAuth.do ==========");
	...
	/**
	 * 기능   : 인증 메일 URL 클릭시 메일 인증 진행 후 JSP 페이지 반환 :: 
	 * 비고   : API 문서엔 적혀있지 않음
	 * 작성자 : 정주현 
	 * 작성일 : 2022. 04. 27
	 * 수정일 : 2022. 08. 02
	...
	public String signUpConfirm(@RequestParam Map<String, String> paramMap) throws Exception {

		logger.debug("========== MailAuthController ========== emailConfirm.do ==========");
	...
	public HashMap<String,Object> emailAuthChk(@RequestBody Map<String, String> paramMap) throws Exception {
		...
		logger.debug("========== MailAuthController ========== emailAuthChk.do ==========");
